  ...
  return (
    <section className="py-24 lg:py-32 bg-[#E8E5DC]">
      <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
        <h2 className="font-brush text-4xl md:text-5xl lg:text-6xl text-[#5F6A54] text-balance">
          ¿Querés una pieza que transforme tu espacio?
        </h2>
        <p className="mt-6 text-lg text-[#6B6B6B] max-w-2xl mx-auto">
          Explorá nuestro catálogo o escribinos para crear juntos la obra perfecta para tu ambiente.
        </p>
        <p className="mt-4 text-base text-[#8E927B] max-w-2xl mx-auto italic">
          Todas nuestras obras cuentan con certificado de autenticidad que garantiza que corresponde a un original Dellepiane.
        </p>
